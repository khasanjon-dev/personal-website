...
from django.db.models import CharField, ImageField, EmailField, BooleanField, DateTimeField, TextField
...
class User(AbstractBaseUser, PermissionsMixin):
    image = ImageField(upload_to='images/users', null=True, blank=True,
                       default='images/users/default-user-profile-picture.jpg')
